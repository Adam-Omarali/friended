      ...
      <body className="w-full  min-h-screen">
        <div className="">
            ...
            <div id="topRightCorrelation" className="flex absolute top-5  w-16 h-16 ml-10">
                <button id="customButton" className="text-lightpink font-black text-3xl font-poppins bg-white rounded-2xl  py-2 px-3 leading-tight"><Link href="/spaces">spaces.</Link></button>
        ...
        <div className="flex relative w-500px h-48px group justify-center  mt-7" id="spaceSearch">
            <input className="drop-shadow-2xl bg-lightgray placeholder-lightpurple text-xl font-bold shadow appearance-none border rounded-2xl w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"  type="text" placeholder={spaceChoice}/>
        ...
        (<div className="justify-center">
            ...
            {
                searchRequest==='' ? (<h2 className="description">currently showing those most similar to you.</h2>) 
